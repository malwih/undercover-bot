...
class WebcastHttpClient {
    ...
    }, webSigner = new lib_1.EulerSigner()) {
    ...
    async request({ host, path, params, signRequest, method = 'GET', headers, ...extraOptions }) {
        ...
        if (signRequest) {
            ...
            const signResponse = await this.webSigner.webcastSign(url, method.toUpperCase(), this.axiosInstance.defaults.headers['User-Agent']);
